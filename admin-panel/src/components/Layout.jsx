                ...
                <header className="flex flex-col xl:flex-row justify-between items-start xl:items-center gap-4 mb-4 animate-fade-up">
                    ...
                    >
                        <div className="text-right flex-1 xl:flex-initial">
                            <p className="text-sm font-bold text-slate-900 tracking-tight mb-0.5">
                                {user?.name || 'Adesh Bhongale'}
                            </p>
                            <p className="text-[10px] font-bold text-indigo-600 tracking-tight bg-indigo-50 px-2 py-0.5 rounded-full border border-indigo-100 inline-block">
                                {user?.designation || 'Infrastructure administrator'}
                            </p>
                        </div>
                        <div className="w-10 h-10 rounded-xl bg-indigo-600 text-white flex items-center justify-center font-bold text-lg shadow-lg shadow-indigo-100 group-hover:rotate-6 transition-transform overflow-hidden">
                            {user?.profileImage ? (
